...
| `-t string`                         | from the address        | abs.filepath, but needs confirmation for securty reasons | rel. filepath (to where the tool is called from), but needs confirmation for security reasons | -                                     | -                                        |     |
